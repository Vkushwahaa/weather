    ...
    return SafeArea(
      ...
      body: Column(
        ...
        children: [
                    ...
                    child: Card(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text("Tempreture : ${snapshot.data!.temp.toString()}",
                              style:
                                  TextStyle(fontSize: 20, color: Colors.white)),
                          Text(
                              "Tempreture Feels Like : ${snapshot.data!.feelslike.toString()}",
                              style:
                                  TextStyle(fontSize: 20, color: Colors.white)),
                          Text(
          ...
          IconButton(onPressed: finaldata, icon: Icon(Icons.abc_rounded))
        ],
      ),
    ));
  }
